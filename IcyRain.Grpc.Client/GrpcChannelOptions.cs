...
/// <summary>An options class for configuring a <see cref="GrpcChannel"/></summary>
public sealed class GrpcChannelOptions
{
    ...
    /// <para>A <c>null</c> value removes the maximum message size limit. Defaults to <c>null</c></para>
    /// </summary>
    ...
    /// <para>A <c>null</c> value removes the maximum message size limit. Defaults to 4,194,304 (4 MB)</para>
    /// </summary>
    ...
    /// </para>
    /// <para>A <c>null</c> value removes the maximum retry attempts limit. Defaults to 5</para>
    ...
    /// using <see cref="ServiceConfig"/>
    /// </para>
    /// <para>A <c>null</c> value removes the maximum retry buffer size limit. Defaults to 16,777,216 (16 MB)</para>
    /// <para>Note: Experimental API that can change or be removed without any prior notice</para>
    /// </summary>
    ...
    /// using <see cref="ServiceConfig"/>
    /// </para>
    /// <para>A <c>null</c> value removes the maximum retry buffer size limit per call. Defaults to 1,048,576 (1 MB)</para>
    /// <para>Note: Experimental API that can change or be removed without any prior notice</para>
    /// </summary>
    public long? MaxRetryBufferPerCallSize { get; set; }

    /// <summary>Gets or sets the <see cref="System.Net.Http.HttpClient"/> used by the channel to make HTTP calls</summary>
    /// <remarks>
    /// <para>
    ...
    /// <summary>Gets or sets the <see cref="HttpMessageHandler"/> used by the channel to make HTTP calls</summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// <para>If this property is set to <c>true</c>, call credentials are always used by a channel</para>
    /// </remarks>
    ...
    /// </para>
    /// <para>A <c>null</c> value removes the maximum reconnect backoff limit. The default value is 120 seconds</para>
    /// <para>Note: Experimental API that can change or be removed without any prior notice</para>
    /// </summary>
    ...
    /// <summary>Gets or sets the <see cref="IServiceProvider"/> the channel uses to resolve types
    /// <para>Note: Experimental API that can change or be removed without any prior notice</para>
    /// </summary>
    ...
    /// be overridden.
    /// </para>
    /// <para>A <c>null</c> value doesn't override the HTTP version of gRPC calls. Defaults to <c>2.0</c></para>
    /// </summary>
    ...
    /// </para>
    /// <para>A <c>null</c> value doesn't override the HTTP policy of gRPC calls. Defaults to <see cref="HttpVersionPolicy.RequestVersionExact"/></para>
    /// </summary>
    public HttpVersionPolicy? HttpVersionPolicy { get; set; }

    internal T ResolveService<T>(T defaultValue)
        => (T?)ServiceProvider?.GetService(typeof(T)) ?? defaultValue;

    /// <summary>Initializes a new instance of the <see cref="GrpcChannelOptions"/> class</summary>
