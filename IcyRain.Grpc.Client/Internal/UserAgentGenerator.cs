...
internal static class UserAgentGenerator
{
    ...
    internal static string GetUserAgentString(Architecture processArch, Version? clrVersion, string? assemblyVersion,
        string? runtimeInformation, string? frameworkName, string? operatingSystem)
    {
    ...
    private static string GetGrpcDotNetVersion(string? assemblyVersion)
    {
        ...
        if (!string.IsNullOrEmpty(assemblyVersion))
        {
            ...
            int plusIndex = assemblyVersion!.IndexOf('+');
