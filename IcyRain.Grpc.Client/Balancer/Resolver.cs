...
public abstract class Resolver : IDisposable
{
    ...
    /// <para>This is only a hint. Implementation takes it as a signal but may not start resolution</para>
    /// </summary>
    public virtual void Refresh() { } // no-op
    ...
    /// <summary>Disposes the <see cref="Resolver"/>. Stops resolution</summary>
    public void Dispose()
    {
...
/// <summary>Represents the results from a <see cref="Resolver"/>
/// <para>Note: Experimental API that can change or be removed without any prior notice</para>
/// </summary>
public sealed class ResolverResult
{
    ...
    /// <summary>Gets the status. A status other than <see cref="StatusCode.OK"/> indicates failure</summary>
    public Status Status { get; }

    /// <summary>Gets a collection of resolved addresses</summary>
    public IReadOnlyList<BalancerAddress>? Addresses { get; }

    /// <summary>Gets an optional service config</summary>
    public ServiceConfig? ServiceConfig { get; }

    /// <summary>Gets an optional service config status</summary>
    public Status? ServiceConfigStatus { get; }

    /// <summary>Gets metadata attributes</summary>
    public BalancerAttributes Attributes => _attributes ??= new();

    /// <summary>Create <see cref="ResolverResult"/> for failure</summary>
    ...
    /// <summary>Create <see cref="ResolverResult"/> for the specified addresses</summary>
    ...
    public static ResolverResult ForResult(IReadOnlyList<BalancerAddress> addresses)
        => new ResolverResult(Status.DefaultSuccess, addresses, serviceConfig: null, serviceConfigStatus: null);
