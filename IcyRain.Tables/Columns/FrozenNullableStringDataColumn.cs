...
public sealed class FrozenNullableStringDataColumn : FrozenSingleDataColumn<string>
{
    internal FrozenNullableStringDataColumn(NullableStringDataColumn dataColumn) : base(dataColumn) { }
