...
namespace IcyRain.Benchmarks
{
    ...
    public class BoolBenchmarks
    {
        ...
        private static readonly Google.Protobuf.MessageParser<Google.Protobuf.WellKnownTypes.BoolValue> _parser = new(() => new());
        ...
        public void IcyRain_DeepClone()
            => new TestBufferWriter().DeepClone(Value, v => Serialization.Serialize(v), b => Serialization.Deserialize<bool>(b));
        ...
        public void ZeroFormatter_DeepClone()
            => new TestBufferWriter().DeepClone(Value, v => ZeroFormatterSerializer.Serialize(v), b => ZeroFormatterSerializer.Deserialize<bool>(b));
        ...
        public void MessagePack_DeepClone()
            => new TestBufferWriter().DeepClone(Value, (b, v) => MessagePackSerializer.Serialize(b, v), s => MessagePackSerializer.Deserialize<bool>(s));
        ...
        public void ProtoBufNet_DeepClone()
            => new TestBufferWriter().DeepClone(Value, (b, v) => ProtoBuf.Serializer.Serialize(b, v), s => ProtoBuf.Serializer.Deserialize<bool>(s));


        [Benchmark(Description = "Google.Protobuf"), BenchmarkCategory("Serialize")]
        public void GoogleProtobuf_Ser()
        {
            var value = new Google.Protobuf.WellKnownTypes.BoolValue() { Value = Value };
