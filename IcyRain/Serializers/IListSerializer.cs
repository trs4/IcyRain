    ...
    where TResolver : Resolver
{
    ...
    public override sealed IList<T> Deserialize(ref Reader reader)
    {
    ...
    public override sealed IList<T> DeserializeInUTC(ref Reader reader)
    {
        int length = reader.ReadInt();
    ...
    public override sealed IList<T> DeserializeSpot(ref Reader reader)
    {
        int length = reader.ReadInt();
    ...
    public override sealed IList<T> DeserializeInUTCSpot(ref Reader reader)
    {
        int length = reader.ReadInt();
