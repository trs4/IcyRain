...
internal sealed class IReadOnlyDictionarySerializer<TResolver, TKey, TValue> : Serializer<TResolver, IReadOnlyDictionary<TKey, TValue>>
    where TResolver : Resolver
{
    ...
    public IReadOnlyDictionarySerializer()
    {
    ...
    [MethodImpl(Flags.HotPath)]
    public override sealed int GetCapacity(IReadOnlyDictionary<TKey, TValue> value)
    {
    ...
    private int CalculateCapacity(IReadOnlyDictionary<TKey, TValue> value)
    {
        int capacity = 4;
    ...
    public override sealed void Serialize(ref Writer writer, IReadOnlyDictionary<TKey, TValue> value)
    {
    ...
    public override sealed void SerializeSpot(ref Writer writer, IReadOnlyDictionary<TKey, TValue> value)
    {
    ...
    public override sealed IReadOnlyDictionary<TKey, TValue> Deserialize(ref Reader reader)
    {
    ...
    public override sealed IReadOnlyDictionary<TKey, TValue> DeserializeInUTC(ref Reader reader)
    {
        int length = reader.ReadInt();
    ...
    public override sealed IReadOnlyDictionary<TKey, TValue> DeserializeSpot(ref Reader reader)
    {
        int length = reader.ReadInt();
    ...
    public override sealed IReadOnlyDictionary<TKey, TValue> DeserializeInUTCSpot(ref Reader reader)
    {
        int length = reader.ReadInt();
