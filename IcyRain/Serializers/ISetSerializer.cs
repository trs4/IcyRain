...
namespace IcyRain.Serializers
{
        ...
        where TResolver : Resolver
    {
        ...
        public override sealed ISet<T> Deserialize(ref Reader reader, DeserializeOptions options)
        {
        ...
        public override sealed ISet<T> DeserializeSpot(ref Reader reader, DeserializeOptions options)
        {
            int length = reader.ReadInt();
            var value = new HashSet<T>(length, _comparer);
