...
namespace IcyRain.Serializers
{
        ...
        where TResolver : Resolver
    {
        ...
        public override sealed IReadOnlyCollection<T> Deserialize(ref Reader reader, DeserializeOptions options)
        {
        ...
        public override sealed IReadOnlyCollection<T> DeserializeSpot(ref Reader reader, DeserializeOptions options)
        {
            int length = reader.ReadInt();
