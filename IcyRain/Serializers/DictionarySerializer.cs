    ...
    where TResolver : Resolver
{
    ...
    public override sealed Dictionary<TKey, TValue> Deserialize(ref Reader reader)
    {
    ...
    public override sealed Dictionary<TKey, TValue> DeserializeInUTC(ref Reader reader)
    {
        int length = reader.ReadInt();
    ...
    public override sealed Dictionary<TKey, TValue> DeserializeSpot(ref Reader reader)
    {
        int length = reader.ReadInt();
        var value = new Dictionary<TKey, TValue>(length, _comparer);
    ...
    public override sealed Dictionary<TKey, TValue> DeserializeInUTCSpot(ref Reader reader)
    {
        int length = reader.ReadInt();
        var value = new Dictionary<TKey, TValue>(length, _comparer);
