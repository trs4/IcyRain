...
namespace IcyRain.Serializers
{
        ...
        where TResolver : Resolver
    {
        ...
        public override sealed IReadOnlyList<T> Deserialize(ref Reader reader, DeserializeOptions options)
        {
        ...
        public override sealed IReadOnlyList<T> DeserializeSpot(ref Reader reader, DeserializeOptions options)
        {
            int length = reader.ReadInt();
