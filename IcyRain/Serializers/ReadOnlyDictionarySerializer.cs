...
namespace IcyRain.Serializers
{
        ...
        where TResolver : Resolver
    {
        ...
        public override sealed ReadOnlyDictionary<TKey, TValue> Deserialize(ref Reader reader, DeserializeOptions options)
        {
        ...
        public override sealed ReadOnlyDictionary<TKey, TValue> DeserializeSpot(ref Reader reader, DeserializeOptions options)
        {
            int length = reader.ReadInt();
