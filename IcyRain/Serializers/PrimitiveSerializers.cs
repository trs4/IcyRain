...
namespace IcyRain.Serializers
{
        ...
        where TResolver : Resolver
    {
        ...
        [MethodImpl(Flags.HotPath)]
        public override sealed string DeserializeSpot(ref Reader reader, DeserializeOptions options)
    ...
    {
        [MethodImpl(Flags.HotPath)]
        public override sealed int? GetSize() => 13;

        [MethodImpl(Flags.HotPath)]
        public override sealed int GetCapacity(DateTime value) => 13;
        ...
        where TResolver : Resolver
    {
        ...
        [MethodImpl(Flags.HotPath)]
        public override sealed ArraySegment<byte> Deserialize(ref Reader reader, DeserializeOptions options)
        {
        ...
        [MethodImpl(Flags.HotPath)]
        public override sealed ArraySegment<byte> DeserializeSpot(ref Reader reader, DeserializeOptions options)
        ...
        where TResolver : Resolver
    {
        ...
        [MethodImpl(Flags.HotPath)]
        public override sealed Memory<byte> Deserialize(ref Reader reader, DeserializeOptions options)
        {
            int length = reader.ReadInt();
        ...
        [MethodImpl(Flags.HotPath)]
        public override sealed Memory<byte> DeserializeSpot(ref Reader reader, DeserializeOptions options)
        ...
        where TResolver : Resolver
    {
        ...
        [MethodImpl(Flags.HotPath)]
        public override sealed ReadOnlyMemory<byte> Deserialize(ref Reader reader, DeserializeOptions options)
        {
            int length = reader.ReadInt();
        ...
        [MethodImpl(Flags.HotPath)]
        public override sealed ReadOnlyMemory<byte> DeserializeSpot(ref Reader reader, DeserializeOptions options)
        ...
        where TResolver : Resolver
    {
        ...
        [MethodImpl(Flags.HotPath)]
        public override sealed ReadOnlySequence<byte> Deserialize(ref Reader reader, DeserializeOptions options)
        {
            int length = reader.ReadInt();
        ...
        [MethodImpl(Flags.HotPath)]
        public override sealed ReadOnlySequence<byte> DeserializeSpot(ref Reader reader, DeserializeOptions options)
