...
namespace IcyRain.Compression.LZ4
{
    internal partial class LZ4DecoderStream
    {
        ...
        private async Task<int> ReadBlock(CancellationToken token)
        {
            ...
            await InnerReadBlock(_buffer, 0, blockLength, token).Weave();
        ...
        private async Task<int> ReadImpl(Memory<byte> buffer, CancellationToken token)
        {
