...
internal unsafe class Mem64 : Mem
{
    ...
    [MethodImpl(Flags.HotPath)]
    public new static void Copy1(byte* target, byte* source) => *target = *source;

    /// <summary>Copies exactly 2 bytes from source to target</summary>
    /// <param name="target">Target address</param>
    /// <param name="source">Source address</param>
    [MethodImpl(Flags.HotPath)]
    public new static void Copy2(byte* target, byte* source) => *(ushort*)target = *(ushort*)source;

    /// <summary>Copies exactly 4 bytes from source to target</summary>
    /// <param name="target">Target address</param>
    /// <param name="source">Source address</param>
    [MethodImpl(Flags.HotPath)]
    public new static void Copy4(byte* target, byte* source) => *(uint*)target = *(uint*)source;
    ...
    /// <param name="source">Source address</param>
    [MethodImpl(Flags.HotPath)]
    public new static void Copy8(byte* target, byte* source) => *(ulong*)target = *(ulong*)source;
